...
// 📌 DRIBLE DO BUILD DA RAILWAY (Lê a variável sem travar o Railpack)
const nomeDaChave = "DISCORD_TOKEN";
const TOKEN = process.env[nomeDaChave];
...
// -------------------------------------------------------------------------
// MONITORAMENTO AUTOMÁTICO (SÓ COM OS SEUS EMOJIS CUSTOMIZADOS)
// -------------------------------------------------------------------------
