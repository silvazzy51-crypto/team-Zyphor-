// 📦 SISTEMA AUTO-INSTALÁVEL PARA A RAILWAY (Evita o erro MODULE_NOT_FOUND)
try {
    require('unidecode');
} catch (e) {
...
// 📌 CONFIGURAÇÕES PROTEGIDAS (Lendo em segredo das variáveis da Railway)
...
client.on('ready', async () => {
    ...
    console.log(`[INFO] Proteção activa com emojis customizados e variáveis seguras.`);
    console.log(`▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬`);
...
if (!TOKEN) {
    console.error("[ERRO CRÍTICO] A variável DISCORD_TOKEN não foi configurada na Railway!");
    process.exit(1);
}
client.login(TOKEN);
